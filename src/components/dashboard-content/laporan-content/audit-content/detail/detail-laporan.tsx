                                ...
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input
                                            ...
                                            readOnly={laporan?.isApproved === true || userInfo?.role?.name !== "Admin Auditor"}
                                            className={`${userInfo?.role?.name !== "Admin Auditor" ? "bg-gray-200" : ""}`}
                                        />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                                ...
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Textarea
                                            ...
                                            readOnly={laporan?.isApproved === true || userInfo?.role?.name !== "Admin Auditor"}
                                            className={`min-h-[150px] ${userInfo?.role?.name !== "Admin Auditor" ? "bg-gray-200" : ""}`}
                                        />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
