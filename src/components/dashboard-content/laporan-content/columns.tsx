...
export const indicatorColumn: ColumnDef<Indicator>[] = [
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            const persenCapaian = ((progress / Number(target)) * 100).toFixed(2)
            return `${persenCapaian}%`
        }
    },
    {
        ...
        cell: ({ row }) => {
            ...
            return (
                <div>
                    ...
                    <TooltipProvider>
                        <Tooltip>
                            <Link href={`/laporan/${indicator.id}/audit?indicatorId=${indicator.id}`}>
